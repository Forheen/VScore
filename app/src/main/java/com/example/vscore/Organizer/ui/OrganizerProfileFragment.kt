...
import com.example.vscore.databinding.FragmentOrgProfileBinding
...
class OrganizerProfileFragment : Fragment() {
    lateinit var binding:FragmentOrgProfileBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOrgProfileBinding.inflate(layoutInflater, container, false)
